...
internal fun List<OcrResult>.toPlayerVideoOcrBlocks(language: String): List<OcrTextBlock> = mapNotNull { result ->
...
internal fun OcrTextBlock.playerVideoOcrCharOffset(tapX: Float, tapY: Float): Int {
